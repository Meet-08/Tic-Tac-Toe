...
const ShowWinner = ({ winner }) => {
  return (
    <div className="flex justify-center items-center">
      <div className="relative top-6 left-6 h-8 w-8 z-10 hidden sm:block">
        {/* Upper */}
      ...
      <p
        className={`relative text-center text-[21px]  leading-[30px] p-2 font-semibold mt-3 sm:w-[365px] w-[200px] bg-green-800 text-white z-20`}
      >
        {winner === ""
          ? "Game over. It's Draw"
      ...
      <div className="relative top-[6px] right-7 h-8 w-8 z-10 rotate-180 hidden sm:block">
        {/* Upper */}
